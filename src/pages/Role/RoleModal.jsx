...
const RoleModal = ({ setShowModal, onSuccess }) => {
  ...
  const handleAddRole = async () => {
    if (!newRole.role_name || !newRole.price) {
    ...
    try {
      const payload = {
        barcode: newRole.barcode,
        sku: newRole.sku,
        role_name: newRole.role_name,
        price: parseInt(newRole.price) || 0,
        stock: parseInt(newRole.stock) || 0,
        min_stock: parseInt(newRole.min_stock) || 0,
        description: newRole.description,
        status: newRole.status === "active" ? 1 : 2,
        merk_id: newRole.merk_id || null,
        category_id: newRole.category_id || null,
        ...
        >
          ...
          <div style={column}>
            ...
            <input
              ...
              value={newRole.barcode}
              onChange={(e) =>
                setNewRole({ ...newRole, barcode: e.target.value })
              }
              style={inputStyle}
            />
            ...
            <input
              ...
              value={newRole.sku}
              onChange={(e) =>
                setNewRole({ ...newRole, sku: e.target.value })
              }
              style={inputStyle}
            />
           ...
           <div style={rowGroup}>
              <div style={{ flex: 1 }}>
                ...
                <select
                  value={newRole.merk_id}
                  onChange={(e) =>
                    setNewRole({ ...newRole, merk_id: e.target.value })
                  }
                  style={inputSmall}
                  required
                >
              ...
              <div style={{ flex: 1 }}>
                ...
                <select
                  value={newRole.category_id}
                  onChange={(e) =>
                    setNewRole({ ...newRole, category_id: e.target.value })
                  }
                  style={inputSmall}
                  required
                >
            ...
            <div style={rowGroup3}>
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  value={newRole.price}
                  onChange={(e) =>
                    setNewRole({ ...newRole, price: e.target.value })
                  }
                  style={inputSmall}
                  required
                />
              ...
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  value={newRole.stock}
                  onChange={(e) =>
                    setNewRole({ ...newRole, stock: e.target.value })
                  }
                  style={inputSmall}
                  required
                />
              ...
              <div style={{ flex: 1 }}>
                ...
                <input
                  type="number"
                  placeholder="5"
                  value={newRole.min_stock}
                  onChange={(e) =>
                    setNewRole({ ...newRole, min_stock: e.target.value })
                  }
                  style={inputSmall}
                  required
                />
