...
const Merchant = () => {
  ...
  const API_URL = "https://cashpay.co.id:2388/api/merchant/get";
  const REFRESH_URL = "https://cashpay.co.id:2356/api/auth/refresh"; // ubah sesuai endpoint refresh token kamu
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        "https://cashpay.co.id:2388/api/merchant/update",
        data,
        {
          headers: {
            Authorization: `Bearer ${getAccessToken()}`,
